...
//          User user = new User("user2", "PeterFraLeasy","Peter", "Larsen", "88698944","peter@mail.com");
//          //user.addRole(userRole);
//          User admin = new User("admin2", "MadsIsTheBest","Mads","Jensen","46809060","Mads@mail.com");
//          //admin.addRole(adminRole);
//          User both = new User("user_admin2", "hans1234", "Hans","Andersen","42301066","hans@mail.com");
